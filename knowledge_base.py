...
collectionArn = utils.collectionArn
if collectionArn is None:
    raise Exception ("No collectionArn")

knowledge_base_role = utils.knowledge_base_role
...
path = utils.sharing_url
if path is None:
    raise Exception ("No Sharing URL")

opensearch_url = utils.opensearch_url
