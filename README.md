...
[google_workspace.md](./google_workspace.md)에서는 Google Docs등을 활용하기 위해 google workspace를 MCP로 등록하는 방법에 대해 설명합니다.
...
[QA agent](./application/qa_agent/agent.py)에서 생성한 결과를 아래와 같이 "qa_test_cases.json"로 저장합니다.
